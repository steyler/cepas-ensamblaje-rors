...
class StrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strain" do
    assert_difference('Strain.count') do
      post strains_url, params: { strain: { name_strain: @strain.name_strain, percentage: @strain.percentage } }
    end
  ...
  test "should update strain" do
    patch strain_url(@strain), params: { strain: { name_strain: @strain.name_strain, percentage: @strain.percentage } }
